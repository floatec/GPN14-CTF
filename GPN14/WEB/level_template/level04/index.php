  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="center-div">
        ...
        <p class="lead">
          <b>DAMN!!!!</b> Somebody h4ck3d my Web site!!! The attackers said they used XSS!!! To stop them I now use Chrome 30, which has <b><u>the XSS Auditor!!</u></b> Furthermore, I now use Google Analytics to track you evil h4ck3rs!!!! Nobody will ever h4ck me again!!! Muhahaha....!
        </p>
        <p class="lead">
          I need to learn more about XSS. Please send me more links!
        </p>
        ...
        <?php
           if(array_key_exists("link", $_GET)){
             echo "Thank you for posting a <a href=\"".$_GET["link"]."*I need to look at this\">link</a>! I will have a look at it soon!";
    ...
    <script async="" src="//www.google-analytics.com/analytics.js">/* for security*/</script>
